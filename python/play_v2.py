...
#
comp_type = np.dtype([('Orbit', 'i'), ('Location', 'a6'), ('Temperature (F)', 'f8'), ('Pressure (inHg)', 'f8'), ('Magnitude (dB)', 'f4')])
dataset = file.create_dataset("DSC",(4,), comp_type)
data = np.array([(1153, "Sun   ", 53.23, 24.57, -12.1), (1184, "Moon  ", 55.12, 22.95, -22.5), (1027, "Venus ", 103.55, 31.23, -60.3), (1313, "Mars  ", 1252.89, 84.11, -9.8)], dtype = comp_type)
dataset[...] = data
#
